...
public class LinkedList<E>
    ...
    private void linkFirst(E e) {
        ...
        final Node<E> newNode = new Node<>(null, e, f); //新增一个最前的节点，前驱为空
        first = newNode; //头节点变更为新增的节点
        if (f == null)
            last = newNode; //为空时就说明此链表中没有数据，尾结点也变更为新增的节点
        else
            f.prev = newNode; //原来的头部节点变成第2个，此节点的前驱指向新增的节点
        size++;
        modCount++;
    }
